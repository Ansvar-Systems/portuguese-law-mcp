/**
 * Tool registry for Portuguese Law MCP Server.
...
import { getPortugueseImplementations, type GetPortugueseImplementationsInput } from './get-portuguese-implementations.js';
...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Portuguese statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Portugal?" ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_portuguese_implementations':
          result = await getPortugueseImplementations(db, args as unknown as GetPortugueseImplementationsInput);
          break;
